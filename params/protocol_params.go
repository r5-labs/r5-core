...
const (
	...
	CallValueTransferGas  uint64 = 7000  // Original: 9000 // Paid for CALL when the value transfer is non-zero.
	CallNewAccountGas     uint64 = 7000 // Original: 25000 //Paid for CALL when the destination address didn't exist prior.
	TxGas                 uint64 = 7000 // Original: 21000 // Per transaction not creating a contract. NOTE: Not payable on data of calls between transactions.
	TxGasContractCreation uint64 = 53000 // Original: 53000 // Per transaction that creates a contract. NOTE: Not payable on data of calls between transactions.
