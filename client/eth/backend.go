...
import (
	...
	"github.com/r5-labs/r5-core/core/state/pruner"
	...
	"github.com/r5-labs/r5-core/internal/shutdowncheck"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, R5 %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
