...
import (
	...
	"github.com/r5-labs/r5-core/client/crypto/signify"
	"github.com/r5-labs/r5-core/client/internal/build"
...
var (
	...
	debExecutables = []debExecutable{
		{
			BinaryName:  "abigen",
			Description: "Source code generator to convert R5 contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			BinaryName:  "bootnode",
			Description: "R5 bootnode.",
		},
		{
			BinaryName:  "evm",
		...
		{
			BinaryName:  "clef",
			Description: "R5 account management tool.",
		},
	}
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/r5-labs/r5-core/client/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/r5-labs/r5-core/client/internal/version.gitDate="+env.Date)
	}
